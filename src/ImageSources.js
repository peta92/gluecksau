const ImageSources = {
    ...
    deletePoints: {
        uri: require('../assets/drawable/delete_points.png')
    },
    savePoints: {
        uri: require('../assets/drawable/save_points.png')
    },
    buzzer: {
        uri: require('../assets/drawable/buzzer.png')
    },
    vaultingBox: {
        uri: require('../assets/drawable/vaulting_box.png')
    },
    vaultingHorse: {
        uri: require('../assets/drawable/vaulting_horse.png')
    },
    mat: {
        uri: require('../assets/drawable/mat.png')
    },
    rings: {
        uri: require('../assets/drawable/rings.png')
    },
    longBench: {
